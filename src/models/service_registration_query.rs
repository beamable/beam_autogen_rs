...
pub struct ServiceRegistrationQuery {
    ...
    pub federation: Option<Box<models::BeamoActorSupportedFederation>>,
}

impl ServiceRegistrationQuery {
    pub fn new() -> ServiceRegistrationQuery {
