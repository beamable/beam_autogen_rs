...
pub struct BeamoActorServiceReference {
    ...
    pub dependencies: Option<Option<Vec<models::BeamoActorServiceDependencyReference>>>,
    ...
    pub components: Option<Option<Vec<models::BeamoActorServiceComponent>>>,
    #[serde(rename = "checksum", skip_serializing_if = "Option::is_none")]
    pub checksum: Option<String>,
}

impl BeamoActorServiceReference {
    pub fn new() -> BeamoActorServiceReference {
