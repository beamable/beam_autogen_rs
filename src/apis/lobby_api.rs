...
pub struct ApiLobbiesPutParams {
    ...
    /// Set the request timeout in seconds. Defaults to 10 seconds.
    pub x_beam_timeout: Option<i32>,
    /// The lobby to create or replace.
...
pub async fn api_lobbies_get(
    configuration: &configuration::Configuration,
    params: ApiLobbiesGetParams,
) -> Result<models::LobbyQueryResponse, Error<ApiLobbiesGetError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::LobbyQueryResponse`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::LobbyQueryResponse`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn api_lobbies_id_delete(
    configuration: &configuration::Configuration,
    params: ApiLobbiesIdDeleteParams,
) -> Result<serde_json::Value, Error<ApiLobbiesIdDeleteError>> {
    let uri_str = format!(
        "{}/api/lobbies/{id}",
...
pub async fn api_lobbies_id_get(
    configuration: &configuration::Configuration,
    params: ApiLobbiesIdGetParams,
) -> Result<models::Lobby, Error<ApiLobbiesIdGetError>> {
    let uri_str = format!(
        "{}/api/lobbies/{id}",
        configuration.base_path,
        id = crate::apis::urlencode(params.id)
...
pub async fn api_lobbies_id_metadata_put(
    configuration: &configuration::Configuration,
    params: ApiLobbiesIdMetadataPutParams,
) -> Result<models::Lobby, Error<ApiLobbiesIdMetadataPutError>> {
    let uri_str = format!(
...
/// Join a lobby
pub async fn api_lobbies_id_put(
    configuration: &configuration::Configuration,
    params: ApiLobbiesIdPutParams,
) -> Result<models::Lobby, Error<ApiLobbiesIdPutError>> {
    let uri_str = format!(
        "{}/api/lobbies/{id}",
        configuration.base_path,
        id = crate::apis::urlencode(params.id)
...
pub async fn api_lobbies_id_server_post(
    configuration: &configuration::Configuration,
    params: ApiLobbiesIdServerPostParams,
) -> Result<serde_json::Value, Error<ApiLobbiesIdServerPostError>> {
    let uri_str = format!(
...
pub async fn api_lobbies_id_tags_delete(
    configuration: &configuration::Configuration,
    params: ApiLobbiesIdTagsDeleteParams,
) -> Result<models::Lobby, Error<ApiLobbiesIdTagsDeleteError>> {
    let uri_str = format!(
        "{}/api/lobbies/{id}/tags",
        configuration.base_path,
        id = crate::apis::urlencode(params.id)
...
pub async fn api_lobbies_id_tags_put(
    configuration: &configuration::Configuration,
    params: ApiLobbiesIdTagsPutParams,
) -> Result<models::Lobby, Error<ApiLobbiesIdTagsPutError>> {
    let uri_str = format!(
        "{}/api/lobbies/{id}/tags",
        configuration.base_path,
        id = crate::apis::urlencode(params.id)
...
pub async fn api_lobbies_passcode_put(
    configuration: &configuration::Configuration,
    params: ApiLobbiesPasscodePutParams,
) -> Result<models::Lobby, Error<ApiLobbiesPasscodePutError>> {
...
pub async fn api_lobbies_post(
    configuration: &configuration::Configuration,
    params: ApiLobbiesPostParams,
) -> Result<models::Lobby, Error<ApiLobbiesPostError>> {
    let uri_str = format!("{}/api/lobbies", configuration.base_path);
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::POST, &uri_str);
...
pub async fn api_lobbies_put(
    configuration: &configuration::Configuration,
    params: ApiLobbiesPutParams,
) -> Result<models::SetLobbyResponse, Error<ApiLobbiesPutError>> {
    let uri_str = format!("{}/api/lobbies", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::PUT, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::SetLobbyResponse`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::SetLobbyResponse`")))),
        }
    } else {
        let content = resp.text().await?;
