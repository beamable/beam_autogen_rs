...
pub struct ApiMailboxPublishPostParams {
    ...
    /// Message request. Use PlayerId for player mailbox, Channel for channel mailbox, or RealmId for realm broadcast.
...
pub async fn api_mailbox_publish_post(
    configuration: &configuration::Configuration,
    params: ApiMailboxPublishPostParams,
) -> Result<serde_json::Value, Error<ApiMailboxPublishPostError>> {
