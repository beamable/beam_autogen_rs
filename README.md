...
*PlayerApi* | [**api_players_player_id_parties_invites_get**](docs/PlayerApi.md#api_players_player_id_parties_invites_get) | **GET** /api/players/{playerId}/parties/invites | 
